...
export type CardSet = {
  ...
  whiteCards?: Maybe<Array<Scalars['String']['output']>>;
};
...
export type BlackCardResolvers<ContextType = any, ParentType extends ResolversParentTypes['BlackCard'] = ResolversParentTypes['BlackCard']> = {
...
export type CardSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['CardSet'] = ResolversParentTypes['CardSet']> = {
  blackCards?: Resolver<Maybe<Array<ResolversTypes['BlackCard']>>, ParentType, ContextType>;
  ...
  whiteCards?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
